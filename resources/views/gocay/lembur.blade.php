            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">Catatan Lembur Karyawan</h2>
                        ...
                        <table class="table table-report sm:mt-2">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center whitespace-nowrap">Nama Karyawan</th>
                                    <th class="text-center whitespace-nowrap">Durasi Lembur</th>
